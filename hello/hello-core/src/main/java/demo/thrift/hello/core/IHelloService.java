 ...
 *  @generated
 */
package demo.thrift.hello.core;
...
public class IHelloService {
  ...
  public interface Iface {
     ...
     * 
     * @param serial * 在生成对应的接口方法时会在其注释添加@param
     * 消息的序号，（只是为了表示多个参数）
     * 
     * @param msg * 在生成对应的接口方法时会在其注释添加@param
     * 接收客户端消息
     */
    public java.lang.String echo(int serial, java.lang.String msg) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void echo(int serial, java.lang.String msg, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public java.lang.String echo(int serial, java.lang.String msg) throws org.apache.thrift.TException
    {
      send_echo(serial, msg);
      return recv_echo();
    }

    public void send_echo(int serial, java.lang.String msg) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void echo(int serial, java.lang.String msg, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      echo_call method_call = new echo_call(serial, msg, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class echo_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.String> {
      ...
      public echo_call(int serial, java.lang.String msg, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class echo<I extends Iface> extends org.apache.thrift.ProcessFunction<I, echo_args> {
      ...
      public echo_result getResult(I iface, echo_args args) throws org.apache.thrift.TException {
        echo_result result = new echo_result();
        result.success = iface.echo(args.serial, args.msg);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class echo<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, echo_args, java.lang.String> {
      ...
      public void start(I iface, echo_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
        iface.echo(args.serial, args.msg,resultHandler);
      }
    }
  ...
  public static class echo_args implements org.apache.thrift.TBase<echo_args, echo_args._Fields>, java.io.Serializable, Cloneable, Comparable<echo_args>   {
    ...
    private static final org.apache.thrift.protocol.TField SERIAL_FIELD_DESC = new org.apache.thrift.protocol.TField("serial", org.apache.thrift.protocol.TType.I32, (short)1);
    ...
    private static final int __SERIAL_ISSET_ID = 0;
     ...
     * 消息的序号，（只是为了表示多个参数）
     */
    public echo_args setSerial(int serial) {
      this.serial = serial;
      setSerialIsSet(true);
      return this;
    }
    ...
    public void unsetSerial() {
      __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __SERIAL_ISSET_ID);
    }

    /** Returns true if field serial is set (has been assigned a value) and false otherwise */
    public boolean isSetSerial() {
      return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __SERIAL_ISSET_ID);
    }

    public void setSerialIsSet(boolean value) {
      __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __SERIAL_ISSET_ID, value);
    }
     ...
     * 接收客户端消息
     */
    public echo_args setMsg(java.lang.String msg) {
      this.msg = msg;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case SERIAL:
        if (value == null) {
          ...
          setSerial((java.lang.Integer)value);
        }
        break;
